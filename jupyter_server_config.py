...
# fixme # c.ServerApp.identity_provider_class = 'jupyter_server.auth.identity.DummyAuthenticator'
...
c.PasswordIdentityProvider.hashed_password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$gmmNPMfh8uu7FfRNwdpkYA$ej6UVMSXy+9XjXo7fGukepmLMe/LYAh/CCrx+XVeLEg'
...
#  Choices: any of ['sha3_224', 'sha3_384', 'sha3_512', 'sha512_256', 'blake2b', 'sha256', 'sm3', 'sha384', 'ripemd160', 'shake_256', 'shake_128', 'md5-sha1', 'md5', 'sha3_256', 'blake2s', 'sha512_224', 'sha224', 'sha512', 'sha1']
#  Default: 'sha256'
...
#  Choices: any of ['sha3_384', 'sha224', 'sha3_224', 'sha3_512', 'sha512', 'md5', 'blake2b', 'sha256', 'sha3_256', 'sha384', 'sha1', 'blake2s']
#  Default: 'sha256'
